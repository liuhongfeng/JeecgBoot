<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="title" :width="800" @ok="handleSubmit">
    <fc-fish-ground-form ref="formComponent" :formDisabled="formDisabled" :formBpm="false" @success="submitSuccess"></fc-fish-ground-form>
  </BasicModal>
</template>
...
<script lang="ts">
  ...
  import FcFishGroundForm from './FcFishGroundForm.vue';
